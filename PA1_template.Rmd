...
This slice of code **loads data from the 'activity.csv'** table. 
The **output** is the summary of the loaded data.
...
Mean and Median for total steps each day also calculated below, as a part of this step.
